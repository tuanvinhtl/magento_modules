...
namespace Magenest\CustomerAttribute\Setup\Patch\Data;
 ...
 */
class AddTenantAttribute implements DataPatchInterface, PatchRevertableInterface
{
    /**
    ...
    public function addPhoneAttribute()
    {
        ...
        $attribute = $this->eavConfig->getAttribute(Customer::ENTITY, 'tenant_name');
